      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('nama_pegawai') is-invalid @enderror" id="nama_pegawai" name="nama_pegawai" placeholder="Masukkan Nama" value="{{ old('nama_pegawai', $pegawai->nama_pegawai) }}" required>
            @error('nama_pegawai')
          ...
          <div class="mb-3">
            ...
            <input type="number" step="any" class="form-control @error('nip') is-invalid @enderror" id="nip" name="nip" placeholder="Masukkan NIP" value="{{ old('nip', $pegawai->nip) }}" required>
            @error('nip')
              <small class="text-danger">{{ $message }}</small>
            @enderror
          </div>
          <div class="mb-3">
            ...
            <div class="form-check">
              <input class="form-check-input" type="radio" name="jenis_kelamin" id="jkLk" value="laki-laki" {{ old('jenis_kelamin') == 'laki-laki' ? 'checked' : ''}} required {{ old('jenis_kelamin', $pegawai->jenis_kelamin) == 'laki-laki' ? 'checked' : ''}}>
              <label class="form-check-label" for="jkLk">
                Laki-laki
              </label>
            </div>
            <div class="form-check">
              <input class="form-check-input" type="radio" name="jenis_kelamin" id="jkP" value="perempuan" {{ old('jenis_kelamin') == 'perempuan' ? 'checked' : ''}} required {{ old('jenis_kelamin', $pegawai->jenis_kelamin) == 'perempuan' ? 'checked' : ''}}>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" id="tempat_lahir" name="tempat_lahir" placeholder="Masukkan Tempat Lahir" required value="{{ old('tempat_lahir', $pegawai->tempat_lahir) }}">
            @error('tempat_lahir')
              <small class="text-danger">{{ $message }}</small>
            @enderror
          </div>
          <div class="mb-3">
            ...
            <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" name="tanggal_lahir" placeholder="Masukkan Tanggal Lahir" required value="{{ old('tanggal_lahir', $pegawai->tanggal_lahir) }}">
            @error('tanggal_lahir')
              <small class="text-danger">{{ $message }}</small>
            @enderror
          </div>
          <div class="mb-3">
            ...
            <select class="form-select @error('id_jabatan') is-invalid @enderror" id="id_jabatan" name="id_jabatan" required>
              ...
              @foreach ($data_jabatan as $item)
                <option value="{{ $item->id_jabatan }}" {{ old('id_jabatan', $pegawai->id_jabatan) == $item->id_jabatan ? 'selected' : '' }}>{{ $item->nama_jabatan }}</option>
              @endforeach
            </select>
            @error('id_jabatan')
              <small class="text-danger">{{ $message }}</small>
          ...
          <div class="mb-3">
            ...
            <textarea class="form-control @error('alamat') is-invalid @enderror" id="alamat" name="alamat" placeholder="Masukkan Alamat" required>{{ old('alamat', $pegawai->alamat) }}</textarea>
            @error('alamat')
              <small class="text-danger">{{ $message }}</small>
            @enderror
          </div>
        ...
        <div class="col-lg-6">
            <div class="mb-3">
                ...
                <input type="number" step="any" class="form-control @error('no_telp') is-invalid @enderror" id="no_telp" name="no_telp" placeholder="Masukkan Nomor Telepon" required value="{{ old('no_telp', $pegawai->no_telp) }}">
                @error('no_telp')
                  <small class="text-danger">{{ $message }}</small>
                @enderror
              </div>
          <div class="mb-3">
            ...
            <input type="file" class="form-control mb-1 @error('foto') is-invalid @enderror" id="form-foto" name="foto" >
            @error('foto')
            ...
            <div class="row">
              <div class="col-8">
                <img id="foto-preview" src="{{ $pegawai->foto ? url($pegawai->foto) : 'https://upload.wikimedia.org/wikipedia/commons/8/89/Portrait_Placeholder.png' }}" alt="Foto Karyawan" class="object-fit-cover img-fluid rounded-pill"
