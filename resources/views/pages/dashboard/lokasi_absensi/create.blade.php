...
<div class="p-4 bg-white rounded-3">
  ...
  <form action="{{ route('lokasi_absensi.store') }}" method="post" class="d-flex flex-column"
      ...
      <div class="col-lg-6">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('nama_lokasi') is-invalid @enderror" id="nama_lokasi"
            name="nama_lokasi" placeholder="Masukkan Nama" value="{{ old('nama_lokasi') }}" required>
          @error('nama_lokasi')
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control @error('longitude') is-invalid @enderror" id="longitude"
            name="longitude" placeholder="Masukkan Longitude" value="{{ old('longitude') }}" required>
          @error('longitude')
          <small class="text-danger">{{ $message }}</small>
          @enderror
        </div>
        <div class="mb-3">
          ...
          <input type="number" step="any" class="form-control @error('radius') is-invalid @enderror" id="radius" name="radius"
            placeholder="Masukkan Radius" value="{{ old('radius', 100) }}" required>
          @error('radius')
          <small class="text-danger">{{ $message }}</small>
          @enderror
        </div>
